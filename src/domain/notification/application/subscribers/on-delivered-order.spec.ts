...
import { OnDeliveredOrder } from './on-delivered-order';
...
describe('On Delivered Order', () => {
  beforeEach(() => {
    ...
    new OnDeliveredOrder(orderRepository, sendNotificationUseCase);
  });

  it('should be able to send a notification when an order be delivered', async () => {
